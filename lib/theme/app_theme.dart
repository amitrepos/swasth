...
abstract final class AppColors {
  ...
  static const Color primary = Color(
    0xFF0EA5E9,
  ); // sky-500 — buttons, rings, accents
  static const Color success = Color(
    0xFF10B981,
  ); // emerald-500 — healthy states
  static const Color amber = Color(
    0xFFF59E0B,
  ); // amber-500 — streak, points, caution
  static const Color warning = Color(
    0xFFB45309,
  ); // amber-800 — pending/warning text on white (WCAG AA)
  ...
  static const Color bgGrouped = Color(
    0xFFE0F2FE,
  ); // sky-100 — grouped sections
  ...
  static const Color glassCardBorder = Color(
    0xFFBAE6FD,
  ); // sky-200 — visible border on sky-50 bg
  static const Color glassShadow = Color(
    0x1A1F2687,
  ); // blue shadow — 12% opacity
  ...
  static const Color iosPurple = Color(
    0xFF818CF8,
  ); // indigo-400 (replaces old purple)
  ...
  static const Color cameraFlashOn = Color(0xFFFFEB3B); // yellow — flash-active icon
  static const Color cameraGuideAccent = Color(0xFF69F0AE); // greenAccent — guide-box corner marks

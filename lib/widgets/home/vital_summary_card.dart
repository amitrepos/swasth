...
/// Shows 90-day vital averages (BP, Sugar, Steps) with trend indicators.
            ...
            children: [
              Expanded(
                child: _VitalTile(
                  ...
                  subLabel: bpAvgLabel,
                  value: bpLabel,
                  trendLabel: helpers.trendLabel(avgSys, prevAvgSys, lowerIsBetter: true),
                  trendColor: helpers.trendColor(avgSys, prevAvgSys, lowerIsBetter: true),
                ),
              ),
              ...
              Expanded(
                child: _VitalTile(
                  ...
                  value: glucoseLabel,
                  trendLabel: helpers.trendLabel(avgGlucose, prevAvgGlucose, lowerIsBetter: true),
                  trendColor: helpers.trendColor(avgGlucose, prevAvgGlucose, lowerIsBetter: true),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(

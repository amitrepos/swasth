                    ...
                    children: [
                      ...
                      if (dailyEnabled)
                        ListTile(
                          ...
                          onTap: () async {
                            final time = await pickReminderTimeForSheet(sheetCtx, initialTime: dailyTime, helpText: l10n.reminderChangeTime);
                            if (time == null) {
                              setSheetState(() {});
                              return;
                            }
                      ...
                      SwitchListTile(
                        ...
                        onChanged: (on) async {
                          if (on) {
                            final time = await pickReminderTimeForSheet(sheetCtx, initialTime: weightTime, helpText: l10n.weightReminderSetTime);
                            if (time == null) {
                              setSheetState(() {});
                              return;
                            }
                      ...
                      if (weightEnabled) ...[
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                            final time = await pickReminderTimeForSheet(sheetCtx, initialTime: weightTime, helpText: l10n.weightReminderChangeTime);
                            if (time == null) {
                              setSheetState(() {});
                              return;
                            }

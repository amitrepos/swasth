...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get ppDoctorSharingTitle => 'डॉक्टर डेटा साझाकरण';

  @override
  String get ppDoctorSharing =>
      'यदि आप अपनी प्रोफ़ाइल से कोई डॉक्टर जोड़ते हैं, तो आपकी स्वास्थ्य रीडिंग, रुझान और प्रोफ़ाइल जानकारी उस डॉक्टर को दिखाई देगी। यह साझाकरण आपके नियंत्रण में है — आप प्रोफ़ाइल सेटिंग्स से किसी भी समय डॉक्टर की पहुँच रद्द कर सकते हैं।';

  @override
  String get ppWhatsAppTitle => 'WhatsApp सूचनाएँ';

  @override
  String get ppWhatsApp =>
      'स्वस्थ आपको स्वास्थ्य अलर्ट और साप्ताहिक सारांश भेजने के लिए Twilio WhatsApp Business API का उपयोग करता है। आपको मिलेगा: (1) गंभीर रीडिंग पर तत्काल अलर्ट, (2) वैकल्पिक साप्ताहिक स्वास्थ्य सारांश। WhatsApp संदेशों से बाहर निकलने के लिए support@swasth.app से संपर्क करें।';

  @override
  String get ppLiabilityTitle => 'दायित्व की सीमा';

  @override
  String get ppLiability =>
      'स्वस्थ एक स्वास्थ्य निगरानी उपकरण है, चिकित्सा उपकरण नहीं। यह ऐप निदान, उपचार या नुस्खा प्रदान नहीं करता। सभी सुझाव केवल जानकारी के लिए हैं। किसी भी स्वास्थ्य निर्णय के लिए हमेशा अपने डॉक्टर से मिलें। आपात स्थिति में 112 पर कॉल करें।';
  ...
  String get ppContact =>
      'गोपनीयता संबंधी प्रश्नों या शिकायतों के लिए हमारे शिकायत अधिकारी से संपर्क करें: support@swasth.app। हम आपके अनुरोध के 30 दिनों के भीतर उत्तर देंगे।';

  @override
  String get tosTitle => 'सेवा की शर्तें';

  @override
  String get tosAcceptanceTitle => 'शर्तों की स्वीकृति';

  @override
  String get tosAcceptance =>
      'स्वस्थ का उपयोग करके, आप इन सेवा शर्तों से सहमत होते हैं। यदि आप सहमत नहीं हैं, तो ऐप का उपयोग न करें।';

  @override
  String get tosServiceTitle => 'सेवा विवरण';

  @override
  String get tosService =>
      'स्वस्थ एक व्यक्तिगत स्वास्थ्य निगरानी ऐप है जो रक्त शर्करा, रक्तचाप और संबंधित स्वास्थ्य मेट्रिक्स ट्रैक करने में मदद करता है। यह केवल जानकारी के उद्देश्य से AI-जनित स्वास्थ्य सुझाव प्रदान करता है।';

  @override
  String get tosAiTitle => 'AI सुझाव अस्वीकरण';

  @override
  String get tosAi =>
      'स्वस्थ में AI-जनित सामग्री केवल जानकारी के लिए है। यह पेशेवर चिकित्सा सलाह, निदान या नुस्खे का विकल्प नहीं है। केवल ऐप सुझावों के आधार पर दवा या उपचार कभी न बदलें।';

  @override
  String get tosDoctorTitle => 'डॉक्टर डेटा साझाकरण';

  @override
  String get tosDoctor =>
      'जब आप अपनी प्रोफ़ाइल से डॉक्टर जोड़ते हैं, तो आप अपना स्वास्थ्य डेटा उस डॉक्टर के साथ साझा करने की सहमति देते हैं। आप किसी भी समय डॉक्टर की पहुँच रद्द कर सकते हैं।';

  @override
  String get tosLiabilityTitle => 'दायित्व की सीमा';

  @override
  String get tosLiability =>
      'भारतीय कानून द्वारा अनुमत अधिकतम सीमा तक, स्वस्थ और इसके संस्थापक, कर्मचारी और सेवा प्रदाता किसी भी स्वास्थ्य परिणाम या क्षति के लिए उत्तरदायी नहीं होंगे। ऐप \'जैसा है\' प्रदान किया जाता है।';

  @override
  String get tosTerminationTitle => 'खाता समाप्ति';

  @override
  String get tosTermination =>
      'आप ऐप सेटिंग्स से किसी भी समय अपना खाता हटा सकते हैं। आपका सभी डेटा 30 दिनों के भीतर स्थायी रूप से हटा दिया जाएगा।';

  @override
  String get tosGoverningTitle => 'शासी कानून';

  @override
  String get tosGoverning =>
      'ये शर्तें भारत के कानूनों द्वारा शासित हैं। विवाद नई दिल्ली, भारत के न्यायालयों के अधिकार क्षेत्र में होंगे। ये शर्तें DPDPA 2023 का पालन करती हैं। अंतिम अपडेट: मई 2026।';
  ...
  @override
  String get regReferralCodeLabel => 'आपके डॉक्टर का दिया हुआ कोड (वैकल्पिक)';

  @override
  String get regReferralCodeHint => 'जैसे DRRAJ52';

  @override
  String get regReferralCodeHelper =>
      'अगर आपके डॉक्टर ने कोड दिया है तो यहाँ डालें';
